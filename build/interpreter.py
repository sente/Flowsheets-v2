...
logger = logging.getLogger('FlowSheets')
...
while True:
    ...
    if payload:
        ...
        logger.info(cleaned_payload)
        #log_file.write(cleaned_payload+'\n')
        log_globals = {key: value for key,value in user_globals.items() if key not in ('__builtins__', 'stringify', 'izip', 'starmap', 'starfilter', '_iter_repeat')}
